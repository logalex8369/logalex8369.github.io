/********************************************************************
  DONE 1: Practice changing the case of strings
  ...
  DONE 2: JS is case sensitive. -- Remember how I showed  "ken" and "Ken" are not the same.
  ...
  DONE 3: Clean up the user input. This is an important step in every script that processes user submitted data.
  ...
  DONE I THINK TODO MAYBE 4: Right now you have to reload the page each time. That means the game really can't keep score. Alter the code so that when the player successfully unscrambles a word the game will call the nextWord function.  
...
document.getElementById("scrambledWord").innerHTML = selectedWord.toLowerCase()
